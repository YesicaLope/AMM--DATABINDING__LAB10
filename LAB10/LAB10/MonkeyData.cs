    ...
    public static class MonkeyData
    {
        ...
        static MonkeyData()
        {
            ...
            Monkeys.Add(new Monkey
            {
                ...
                Details = "Los babuinos son monos africanos y árabes del Viejo Mundo que pertenecen al género Papio,parte de la subfamilia Cercopithecinae.",
                ImageUrl = "https://concepto.de/wp-content/uploads/2021/07/mono-e1626908813287.jpg"
            });
            ...
            Monkeys.Add(new Monkey
            {
                ...
                Location = "Brasil",
                Details = "El tití león dorado,también conocido como tití dorado,es un pequeño mono del Nuevo Mundo de la familia Callitrichidae.",
            ...
            Monkeys.Add(new Monkey
            {
                ...
                Location = "Vietnam",
                Details = "El mono de nariz chata de Tonkin o el mono de nariz chata de Dollman es un mono arbóreo del Viejo Mundo de cuerpo delgado, endémico del norte de Vietnam. Es un mono blanco y negro con nariz y labios rosados ​​y manchas azules alrededor de los ojos. Se encuentra en altitudes de 200 a 1200 m (700 a 3900 pies) en parches fragmentarios de bosque en áreas escarpadas de piedra caliza. Descrito por primera vez en 1912, el mono fue redescubierto en 1990, pero es extremadamente raro. En 2008, se pensaba que existían menos de 250 individuos y la especie fue objeto de un intenso esfuerzo de conservación. Las principales amenazas a las que se enfrentan estos monos son la pérdida de hábitat y la caza, y la Unión Internacional para la Conservación de la Naturaleza ha clasificado a la especie como \"en peligro crítico\".",
            ...
            Monkeys.Add(new Monkey
            {
                ...
                ImageUrl = "https://upload.wikimedia.org/wikipedia/commons/thumb/0/02/Semnopith%C3%A8que_blanch%C3%A2tre_m%C3%A2le.JPG/192px-Semnopith%C3%A8que_blanch%C3%A2tre_m%C3%A2le.JPG"
            });
            ...
            Monkeys.Add(new Monkey
            {
                Name = "Gelada",
                Location = "Ethiopia",
                Details = "El gelada, a veces llamado mono del corazón sangrante o babuino gelada, es una especie de mono del Viejo Mundo que se encuentra solo en las tierras altas de Etiopía, con grandes poblaciones en las montañas Semien. Theropithecus se deriva de la raíz griega de \"bestia-mono\". Al igual que sus parientes cercanos, los babuinos, es en gran parte terrestre y pasa gran parte de su tiempo alimentándose en las praderas.",
